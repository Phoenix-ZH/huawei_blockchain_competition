...
func Test_Cert(t *testing.T) {
	...
	if _, err := contract.Send(args1, "addCert", contract.Peer0); err != nil {
		t.Error("Test `addCert` not pass!")
	} else {
		t.Log("Test `addCert` pass!")
	}

	if _, err := contract.Query([]string{"certHash1"}, "queryCert", contract.Peer0); err != nil {
	...
	if _, err := contract.Send(args2, "addCert", contract.Peer0); err != nil {
		t.Error("Test `addCert` not Pass!")
	}

	hashs := []string{certHash1, certHash2}
	if _, err := contract.Query(hashs, "queryCerts", contract.Peer0); err != nil {
	...
	if _, err := contract.Send(args3, "addCert", contract.Peer0); err != nil {
		t.Error("Test `addCert` not Pass!")
	}
	...
	if _, err := contract.Send(args4, "addCert", contract.Peer0); err != nil {
		t.Error("Test `addCert` not Pass!")
	}
}
...
func Test_Item(t *testing.T) {
	...
	if _, err := contract.Send(args1, "addItem", contract.Peer0); err != nil {
		t.Error("Test `addItem` not pass!")
	} else {
		t.Log("Test `assItem` pass!")
	}

	if _, err := contract.Query([]string{item1.Id}, "queryItem", contract.Peer0); err != nil {
	...
	if _, err := contract.Send(args2, "addItem", contract.Peer0); err != nil {
		t.Error("Test `addItem` not pass!")
	}

	hashs := []string{item1.Id, item2.Id}
	if _, err := contract.Query(hashs, "queryItems", contract.Peer0); err != nil {
	...
	if _, err := contract.Send(args3, "addItem", contract.Peer0); err != nil {
		t.Error("Test `addItem` not pass!")
	}
	...
	if _, err := contract.Send(args4, "addItem", contract.Peer0); err != nil {
		t.Error("Test `addItem` not pass!")
	}
}
...
func Test_Person(t *testing.T) {
	...
	if _, err := contract.Send(args, "addPerson", contract.Peer0); err != nil {
		t.Error("Test `addPerson` not pass!")
	} else {
		t.Log("Test `addPerson` pass!")
	}

	if _, err := contract.Query([]string{person.Id}, "queryPerson", contract.Peer0); err != nil {
	...
	if _, err := contract.Send(args1, "addPerson", contract.Peer0); err != nil {
		t.Error("Test `addPerson` not pass!")
	}
}
...
func Test_Issuer(t *testing.T) {
	...
	if _, err := contract.Send(args, "addIssuer", contract.Peer0); err != nil {
		t.Error("Test `addIssuer` not pass!")
	} else {
		t.Log("Test `addIssuer` pass!")
	}

	if _, err := contract.Query([]string{issuer.Id}, "queryIssuer", contract.Peer0); err != nil {
	...
	if _, err := contract.Send(args1, "addIssuer", contract.Peer0); err != nil {
		t.Error("Test `addIssuer` not pass!")
	}
}

func Test_GetPublick(t *testing.T)  {
	if _, err := contract.Query([]string{"p123"}, "getPublicKey", contract.Peer0); err != nil {
		t.Error("Test `getPublicKey` not pass!")
	} else {
		t.Log("Test `getPublicKey` pass!")
	}

	if _, err := contract.Query([]string{"i123"}, "getPublicKey", contract.Peer0); err != nil {
		t.Error("Test `getPublicKey` not pass!")
	}
}
